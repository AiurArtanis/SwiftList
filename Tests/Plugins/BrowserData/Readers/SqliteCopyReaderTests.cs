...
namespace SwiftList.Plugins.BrowserData.Tests.Readers;
...
public sealed class SqliteCopyReaderTests
{
    ...
    {
        var result = SqliteCopyReader.ReadCopy(@"Z:\definitely-not-a-real-swiftlist-file", _ => new List<BrowserEntry> { new("t", "https://x.com", false, 0) });

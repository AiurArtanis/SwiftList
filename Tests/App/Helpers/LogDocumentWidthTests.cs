...
public sealed class LogDocumentWidthTests
{
    ...
    [TestMethod]
    public void LinesNarrowerThanTheViewport_DoNotScroll()
    {
        Assert.AreEqual(Viewport, LogDocumentWidth.Compute([100, 250, 80], Viewport));
    }

    [TestMethod]
    public void TheWidestLineSetsTheRange_NotTheLastOrTheFirst()
    {
        Assert.AreEqual(900 + LogDocumentWidth.TrailingMargin, LogDocumentWidth.Compute([200, 900, 400], Viewport));
    }

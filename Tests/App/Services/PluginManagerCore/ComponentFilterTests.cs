...
namespace SwiftList.App.Tests.Services.PluginManagerCore;
...
public sealed class ComponentFilterTests
{
    ...
    public void GetDllName_ReturnsAssemblyFileNameOfObjectType() =>
        Assert.AreEqual("SwiftList.App.Tests.dll", ComponentFilter.GetDllName(new ComponentFilterTests()));
    ...
    public void GetDllName_DifferentAssembly_ReturnsThatAssemblysFileName() =>
        ...
        Assert.AreEqual("SwiftList.App.dll", ComponentFilter.GetDllName(new ComponentFilter()));

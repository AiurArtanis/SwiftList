...
public static class TutorialTranslationService
{
    ...
    static TutorialTranslationService() => LoadTranslations();

    private static void LoadTranslations()
    {
        var culture = System.Globalization.CultureInfo.CurrentUICulture.Name;
        // Fallback strategy: if it's zh-CN, zh-HK, zh-TW, etc. use zh-CN, otherwise default to en-US.
        var targetCulture = culture.StartsWith("zh", StringComparison.OrdinalIgnoreCase) ? "zh-CN" : "en-US";
        
        var resourceCulture = targetCulture.Replace('-', '_');
        
        var assembly = Assembly.GetExecutingAssembly();
        var resourceName = $"SwiftList.Tutorial.Resources.Translations.{resourceCulture}.Tutorial.json";

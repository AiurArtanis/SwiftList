    ...
    public class ExperienceSettingsViewModel : ViewModelBase
    {
        ...
        public LogLevelOption? SelectedLogLevel
        {
            ...
            set
            {
                ...
                {
                    bool isLogLevelChanged = _userSettings.LogLevel != value.Value;
        ...
        public ThemeOption? SelectedTheme
        {
            ...
            set
            {
                ...
                {
                    bool isThemeIdChanged = _userSettings.Theme != value.Value;
        ...
        public static SwiftList.Core.LogLevel ParseLogLevel(string? value)
        {
            return value switch
            {
                "Error" => SwiftList.Core.LogLevel.Error,
                "Warn" => SwiftList.Core.LogLevel.Warn,
                "Debug" => SwiftList.Core.LogLevel.Debug,
                _ => SwiftList.Core.LogLevel.Info
            };
        }

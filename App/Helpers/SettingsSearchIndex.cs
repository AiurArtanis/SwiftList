...
public static class SettingsSearchIndex
{
    public static IReadOnlyList<SettingsSearchEntry> Entries { get; } = new List<SettingsSearchEntry>
    {
        ...
        new("General_LayoutSectionTitle", "General", vm => vm.General.SelectedTab = "Layout", "RowLayoutSectionTitle", "General_LayoutTitle"),
        new("General_LayoutWidth", "General", vm => vm.General.SelectedTab = "Layout", "RowLayoutWidth", "General_LayoutTitle", "General_LayoutSectionTitle"),
        new("General_LayoutHeight", "General", vm => vm.General.SelectedTab = "Layout", "RowLayoutHeight", "General_LayoutTitle", "General_LayoutSectionTitle"),
        new("General_LayoutShowClock", "General", vm => vm.General.SelectedTab = "Layout", "RowLayoutShowClock", "General_LayoutTitle", "General_LayoutSectionTitle"),
        new("General_LayoutReset", "General", vm => vm.General.SelectedTab = "Layout", "RowLayoutReset", "General_LayoutTitle", "General_LayoutSectionTitle"),
        new("General_ResultTypeOrderTitle", "General", vm => vm.General.SelectedTab = "Layout", "RowResultTypeOrderList", "General_LayoutTitle"),
        ...
        new("General_QuickNavListTitle", "General", vm => vm.General.SelectedTab = "QuickNavigation", "RowQuickNavList", "General_QuickNavTitle"),

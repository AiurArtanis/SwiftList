...
public static class SettingsSearchIndex
{
    public static IReadOnlyList<SettingsSearchEntry> Entries { get; } = new List<SettingsSearchEntry>
    {
        ...
        new("Local_IndexStatus", "Index", vm => vm.LocalDrive.SelectedTab = "Local", "RowLocalRebuild", "Settings_LocalDrive"),
        new("Local_RebuildBtn", "Index", vm => vm.LocalDrive.SelectedTab = "Local", "RowLocalRebuild", "Settings_LocalDrive"),
        new("Settings_NetworkDrive", "Index", vm => vm.LocalDrive.SelectedTab = "Network", "TabNetwork"),
        new("Network_IndexStatus", "Index", vm => vm.LocalDrive.SelectedTab = "Network", "RowNetworkRebuild", "Settings_NetworkDrive"),
        new("Network_RebuildBtn", "Index", vm => vm.LocalDrive.SelectedTab = "Network", "RowNetworkRebuild", "Settings_NetworkDrive"),
        new("Network_WslSectionTitle", "Index", vm => vm.LocalDrive.SelectedTab = "Wsl", "TabWsl"),
        new("Settings_Exclusions", "Index", vm => { vm.LocalDrive.SelectedTab = "Exclusions"; vm.Exclusions.SelectedSubTab = "Path"; }, "SubTabExclusionsPath"),
        new("Exclusions_TabPath", "Index", vm => { vm.LocalDrive.SelectedTab = "Exclusions"; vm.Exclusions.SelectedSubTab = "Path"; }, "SubTabExclusionsPath", "Settings_Exclusions"),
        new("Exclusions_TabGlob", "Index", vm => { vm.LocalDrive.SelectedTab = "Exclusions"; vm.Exclusions.SelectedSubTab = "Glob"; }, "SubTabExclusionsGlob", "Settings_Exclusions"),
        new("Exclusions_TabRegex", "Index", vm => { vm.LocalDrive.SelectedTab = "Exclusions"; vm.Exclusions.SelectedSubTab = "Regex"; }, "SubTabExclusionsRegex", "Settings_Exclusions"),

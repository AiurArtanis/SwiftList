    ...
    internal static class ShellIconShortcutResolver
    {
        public static ImageSource? TryGetShortcutTargetIcon(string shortcutPath)
        {
            ...
            try
            {
                ...
                shellLink.GetIconLocation(iconPathBuilder, iconPathBuilder.Capacity, out int iconIndex);
                string iconPath = Environment.ExpandEnvironmentVariables(iconPathBuilder.ToString());
                ...
                string targetPath = Environment.ExpandEnvironmentVariables(targetPathBuilder.ToString());
        ...
        private static ImageSource? ExtractSmallIcon(string iconPath, int iconIndex)
        {
            ...
            uint extracted = ShellIconNativeMethods.ExtractIconEx(iconPath, iconIndex, null, smallIcons, 1);
        ...
        public static ImageSource? GetShellIconWithoutLinkOverlay(string targetPath)
        {
            ...
            IntPtr res = ShellIconNativeMethods.SHGetFileInfoW(targetPath, 0, ref shfi, (uint)Marshal.SizeOf(shfi), ShellIconNativeMethods.SHGFI_ICON | ShellIconNativeMethods.SHGFI_SMALLICON);

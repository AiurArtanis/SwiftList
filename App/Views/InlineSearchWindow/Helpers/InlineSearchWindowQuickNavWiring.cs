...
{
    public static void Attach(SwiftList.App.InlineSearchWindow window)
    {
    ...
    private static void ShowQuickNavWhenDialogForeground(SwiftList.App.InlineSearchWindow window, IntPtr dialogHwnd, int x, int y)
    {

...
public interface IQueryTokenProvider
{
    ...
    /// provider claims is simply ignored, leaving the rest of the suffix's effect untouched.
    /// </summary>
    ...
    /// the transformed list (reordered and/or filtered, from the same result instances); the host
    /// re-merges it back into the full result list, preserving the relative position of any
    /// non-ordinary rows.
    /// </summary>

...
Acciones de plugins de Atajos, y la subpestaña Pestañas de plugin del Panel de Inicio. Cada resultado muestra una
...
Varias secciones (General, Atajos, Índice, Historial, Panel de Inicio, Estado del Servicio) se dividen además en

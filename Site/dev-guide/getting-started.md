...
Build your plugin and copy the output DLL into the SwiftList App's `Plugins/` folder next to
`SwiftList.App.exe` — the App scans that folder at startup and loads every plugin assembly it

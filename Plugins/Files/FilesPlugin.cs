...
public class FilesPlugin : IPlugin, IConfigurable, ITranslationProvider
{
    public string Name => "Files";
    public string Description => TranslationService.Get("Files_PluginDesc");
    ...
    public PluginConfigSchema GetConfigSchema() => new PluginConfigSchema
    {
        Fields = new List<PluginConfigField>
        {
            new PluginConfigField
            {
                ...
                LabelKey = "Plugins_Files_EnableInlineSearch",
                DescriptionKey = "Plugins_Files_EnableInlineSearchDesc",
            ...
            {
                Key = "EnableQuickNav",
                LabelKey = "Plugins_Files_EnableQuickNav",
                DescriptionKey = "Plugins_Files_EnableQuickNavDesc",
                FieldType = ConfigFieldType.Boolean,
                DefaultValue = true
            }
        }

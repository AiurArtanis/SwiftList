...
public static class Win32Helper
{
        ...
        EnumChildWindows(listerHwnd, (hWnd, lParam) =>
        {
            ...
            if (sb.ToString().Equals("dopus.filedisplaycontainer", StringComparison.OrdinalIgnoreCase))
            {
                if (IsWindowVisible(hWnd))
                {
                    ...
                    {
                        var dx = rect.Left - targetRect.Left;
                        var dy = rect.Top - targetRect.Top;
    ...
    {
        var locationBar = FindWindowExRecursively(parent, IntPtr.Zero, "dopus.ctl.treepath", null);

...
namespace SwiftList.Plugins.CuratedThemes.Providers;

public class CuratedTranslationProvider : ITranslationProvider
{
    public string Name => "Curated Themes Translation Provider";

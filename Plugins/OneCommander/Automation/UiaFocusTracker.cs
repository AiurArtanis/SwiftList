...
/// filter box, ...). Checked via UI Automation's semantic ControlType rather than native window
/// class/caret heuristics, since OneCommander (a WPF host) renders everything inside one native HWND with
/// no distinct child classes for the generic "is a text input focused" check elsewhere in the app to key
/// off.
///
...
/// typing into OneCommander's own address bar. An unthrottled UIA call there risks noticeable input lag,

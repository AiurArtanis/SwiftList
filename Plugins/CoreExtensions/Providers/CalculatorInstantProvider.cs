...
namespace SwiftList.Plugins.CoreExtensions.Providers
{
    public class CalculatorInstantProvider : IInstantResultProvider
    {
        ...
        public IEnumerable<InstantResultItem> GetInstantResults(string query)
        {
            ...
            {
                string numPart = baseMatch.Groups[1].Value;
                string targetBase = baseMatch.Groups[3].Value.ToLowerInvariant();
                ...
                if (parsed)
                {
                    ...
                    string targetName = targetBase switch
                    {
                    ...
                    string desc = TranslationService.Format("Calculator_BaseConv", numPart, targetName);

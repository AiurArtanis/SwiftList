...
public class TypeFilterProvider : ISidebarFilterProvider
{
    ...
    public IEnumerable<SidebarFilterGroup> GetFilterGroups()
    {
        ...
        group.Items.Add(new SidebarFilterItem
        {
            ...
            FilterPredicate = res => !res.IsApplication && res.IsDir
        });
        ...
        group.Items.Add(new SidebarFilterItem
        {
            ...
            FilterPredicate = res => !res.IsApplication && !res.IsDir && DocExts.Contains(Path.GetExtension(res.FullPath))
        });
        ...
        group.Items.Add(new SidebarFilterItem
        {
            ...
            FilterPredicate = res => !res.IsApplication && !res.IsDir && ImageExts.Contains(Path.GetExtension(res.FullPath))
        });
        ...
        group.Items.Add(new SidebarFilterItem
        {
            ...
            FilterPredicate = res => !res.IsApplication && !res.IsDir && VideoExts.Contains(Path.GetExtension(res.FullPath))
        });

...
public class XyplorerPlugin : IPlugin, IConfigurable, ITranslationProvider
{
    public string Name => "XYplorer";
    public string Description => TranslationService.Get("Xyplorer_PluginDesc");
    ...
    public PluginConfigSchema GetConfigSchema() => new PluginConfigSchema
    {
        Fields = new List<PluginConfigField>
        {
            new PluginConfigField
            {
                ...
                LabelKey = "Plugins_Xyplorer_EnableInlineSearch",
                DescriptionKey = "Plugins_Xyplorer_EnableInlineSearchDesc",
            ...
            {
                Key = "EnableQuickNav",
                LabelKey = "Plugins_Xyplorer_EnableQuickNav",
                DescriptionKey = "Plugins_Xyplorer_EnableQuickNavDesc",
                FieldType = ConfigFieldType.Boolean,
                DefaultValue = true
            }
        }

                ...
                new PluginConfigField
                {
                    ...
                    DefaultValue = new List<object>
                    {
                        new Dictionary<string, object>
                        {
                            { "Name", "Baidu" },
                            { "Keyword", "bd" },
                            { "Icon", "M9.154 0C7.71 0 6.54 1.658 6.54 3.707c0 2.051 1.171 3.71 2.615 3.71 1.446 0 2.614-1.659 2.614-3.71C11.768 1.658 10.6 0 9.154 0zm7.025.594C14.86.58 13.347 2.589 13.2 3.927c-.187 1.745.25 3.487 2.179 3.735 1.933.25 3.175-1.806 3.422-3.364.252-1.555-.995-3.364-2.362-3.674a1.218 1.218 0 0 0-.261-.03zM3.582 5.535a2.811 2.811 0 0 0-.156.008c-2.118.19-2.428 3.24-2.428 3.24-.287 1.41.686 4.425 3.297 3.864 2.617-.561 2.262-3.68 2.183-4.362-.125-1.018-1.292-2.773-2.896-2.75zm16.534 1.753c-2.308 0-2.617 2.119-2.617 3.616 0 1.43.121 3.425 2.988 3.362 2.867-.063 2.553-3.238 2.553-3.988 0-.745-.62-2.99-2.924-2.99zm-8.264 2.478c-1.424.014-2.708.925-3.565 2.483-1.642 2.986-.888 7.023 1.83 8.356 2.72 1.334 6.643-.092 7.733-3.084 1.092-2.993-.83-6.618-3.55-7.587a6.22 6.22 0 0 0-2.448-.168zm-.129 1.157c1.782.022 3.14 1.442 3.033 3.169-.107 1.727-1.637 3.092-3.418 3.07-1.781-.023-3.138-1.444-3.03-3.17.106-1.726 1.636-3.092 3.415-3.07z" },
                            { "Url", "https://www.baidu.com/s?wd=%s" },
                            { "SuggestUrl", "https://suggestion.baidu.com/su?action=opensearch&ie=utf-8&wd=%s" }
                        },
                        new Dictionary<string, object>
                        {
                            { "Name", "Google" },
                            { "Keyword", "g" },
                            { "Icon", "M12.24 10.285V14.4h6.887c-.648 2.41-2.519 4.114-5.136 4.114-3.535 0-6.4-2.865-6.4-6.4s2.865-6.4 6.4-6.4c1.582 0 3.02.574 4.136 1.518l3.12-3.12C19.094 2.14 15.918 1 12.24 1c-6.075 0-11 4.925-11 11s4.925 11 11 11c5.833 0 10.744-4.2 11.233-9.715H12.24z" },
                        ...
                        new Dictionary<string, object>
                        {
                            { "Name", "Bing" },
                            { "Keyword", "bing" },
                            { "Icon", "M2.786 2.053a.5.5 0 0 0-.368.147l-1.62 1.62a.5.5 0 0 0 0 .707l7.734 7.734-2.822 1.54a.5.5 0 0 0-.26.438v7.26a.5.5 0 0 0 .74.437l11.084-6.046a.5.5 0 0 0 .26-.438V8.718a.5.5 0 0 0-.146-.353l-2.614-2.614a.5.5 0 0 0-.707 0L10.02 10.799 11.233 1.25a.5.5 0 0 0-.422-.556L3.208 2.067a.5.5 0 0 0-.422-.014z" },
                        ...
                        new Dictionary<string, object>
                        {
                            ...
                            { "SuggestUrl", "https://suggestqueries.google.com/complete/search?client=firefox&ds=yt&q=%s" }
                        }
                    },
